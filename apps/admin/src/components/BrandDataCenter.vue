      ...
      <template v-if="assetDetail">
        ...
        <section class="asset-preview-panel" v-loading="assetPreviewLoading">
          ...
          <div class="preview-actions">
            ...
            <div><el-button :disabled="!assetDetail.objectKey" @click="loadAssetPreview(assetDetail.id)">刷新预览</el-button><el-button type="primary" :disabled="!assetPreviewUrl" @click="openAssetPreview">新窗口打开</el-button><el-button :icon="Download" @click="downloadAsset(assetDetail)">下载原文件</el-button></div>
          </div>
        </section>
