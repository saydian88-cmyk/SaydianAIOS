...
const plainDocument = (text: string) => ({
  type: "doc",
  content: text.split(/\r?\n/).map((line) => ({ type: "paragraph", content: line ? [{ type: "text", text: line }] : undefined })),
});
const content = () => props.document || plainDocument(props.text || "未填写");
...
<style>
.task-rich-content { line-height: 1.75; color: #303133; overflow-wrap: anywhere; }
