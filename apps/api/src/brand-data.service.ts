...
const integrationKinds: IntegrationKind[] = ["DOUYIN", "TIKTOK", "KUAISHOU", "BILIBILI", "AMAZON", "SHOPIFY", "WECHAT_CHANNELS", "XIAOHONGSHU", "WECHAT_OFFICIAL", "WECOM", "TMALL", "JD", "PINDUODUO", "SAIDIAN_MALL", "JUSHUITAN", "FEIGUA", "WEB_SEARCH"];
